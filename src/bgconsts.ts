export class BGCONSTS {
  ...
  static VERSION: string = '23.12.11'
  static VERSION_NUM: number = 231211
  static IS_DEBUG: boolean = false
  static TEST_TOKEN: string = ''
  static BASE_URL: string = 'https://marker.dotalk.cn'
  static OUT: string = 'json'
  static ROOT_PAGE_NAME: string = 'WuCaiHighlights'
  static CLIENT_ID_KEY: string = 'wc-LogseqClientId'
}
